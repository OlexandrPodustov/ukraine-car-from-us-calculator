...
var auctions = [
  {
    ...
    // Провенанс сітки живе поруч із самою сіткою, а не лише в docs/. Сітка
    // Copart успадкована з коміту 2021-07-28, первинного джерела немає
    // (кабінет Member Fees закритий логіном — дві спроби, 2026-08-19 і
    // 2026-08-23). Вторинні джерела дають помітно дорожчу схему, тобто
    // помилка тут іде в бік ЗАНИЖЕННЯ підсумку — про це треба сказати
    // тому, хто ставить ставку, а не лише читачеві docs/.
    feeNote:
      "⚠ сітка зборів Copart не звірена з первинним джерелом (успадкована " +
      "з 2021). Вторинні джерела дають дорожчу схему — підсумок може бути " +
      "занижений. Див. docs/auction-fees-baseline.md",
  },
  {
    id: "iaai",
    name: "IAAI",
    buyerFee: iaaiBuyerFee,
    // Звірено рядок у рядок з офіційним PDF IAA, зріз 2026-08-19.
    feeNote: "",
  },
];
